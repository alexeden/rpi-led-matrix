...
//   const colorIndex: { [hex: number]: string } = Object.entries(colors).red
// uce((index, [name, value]) => ({ ...index, [value]: name }), { });
...
//               const glyphs = LayoutUtils.linesToMappedGlyphs(lines, font.height(),
// matrix.width(), matrix.height(), alignmentH, alignmentV);
